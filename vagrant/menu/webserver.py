        ...
        try:
            ...
            if self.path.endswith("/delete"):
                ...
                if myRestaurantQuery:
                    ...
                    output = ""
                    output += "<html><body>"
                    output += "<h1>DO YOU REALLY WANT TO DELETE THIS RESTAURAN %s ?<h1>" % myRestaurantQuery.name
                    output += "<img src='http://pluspng.com/img-png/delete-button-png-delete-button-png-image-689.png' width='42' height='42'>"
                    output += "<br><br>"
